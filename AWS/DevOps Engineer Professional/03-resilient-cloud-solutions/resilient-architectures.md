...
- How can we make EBS multi AZ?
    ...
    - We create a lifecycle hook for `Start`: copy the snapshot, create an EBS, attach it to the instance
...
![Blue-Green Architecture](blue-green.png)

- Blue-Green with AWS Lambda:

![Blue-Green AWS Lambda Architecture](blue-green-lambda.png)
...
- Health Check types:
    ...
    3. Health checks that monitor CloudWatch alarms: example throttles of DynamoDB, custom metrics, etc.
...
- Ability to set maximum concurrent actions on targets (# or %)
