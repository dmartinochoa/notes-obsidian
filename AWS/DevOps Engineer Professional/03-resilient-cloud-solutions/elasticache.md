...
- AWS takes care of OS maintenance/patching, optimizations, setup, configuration, monitoring, failure recovery, and backups for cache instances
...
| Data durability using AOF persistence                   | No persistence of data                              |
...
- **Cluster Mode Enabled**:
    ...
    - Multi-AZ capability is ON by default
