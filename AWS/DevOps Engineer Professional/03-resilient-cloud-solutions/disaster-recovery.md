...
- Disaster recovery solutions:
    - On-premises to on-premises: traditional DR, expensive
    - On-premises to cloud: hybrid recovery
...
- VM Import/Export:
    ...
    - Ability to create a DR repository for on-premises VMs
    - Ability to export back the VMs from EC2 to on-premises
...
- VM Import/Export:
    ...
    - We can create a DR repository strategy for on-premises VMs
    - We can export back the VMs from EC2 to on-premises
- AWS Application Discovery Service:
    - Gather information about on-premises servers to plan a migration
    - Server utilization and dependency mappings
    - We can track migration with AWS Migration Hub
- AWS Database Migration Service (DMS):
    - Replicate on-premises databases into AWS and vice-versa
