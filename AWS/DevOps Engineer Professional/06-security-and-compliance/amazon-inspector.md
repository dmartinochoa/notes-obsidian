...
- Inspector provides a list of predefined packages (rules), users cannot create their own
- Packages:
...
- Amazon Inspector can be target of an event in EventBridge
...
- Assessment templates can also automatically send messages to an SNS topic. This can be activated from the Inspector using the template settings
