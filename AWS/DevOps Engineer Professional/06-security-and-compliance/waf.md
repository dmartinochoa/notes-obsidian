...
- We can send logs to:
    - CloudWatch Log Groups: rate of 5 MB per second maximum
...
![CloudFront Origin Security with AWS WAF and AWS Secrets Manager](cloudfront-origin-security-with-waf.png)