...
- Used to manage licenses in an account
- Can manage Microsoft, Oracle, SAP, etc. licenses
- We can define rules for the license software. These rules will be attached to resources and by this we will be able to monitor the usage of these licenses
