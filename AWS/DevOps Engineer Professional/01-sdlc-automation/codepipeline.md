...
- Artifacts are encrypted by default with an AWS managed key. We can create our own key in KMS if we want
...
- If CodePipeline fails a stage, the pipeline stops, and we can get information in the console
