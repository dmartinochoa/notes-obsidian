...
- We can specify a pool of users who can approve and number of users who must approve a PR before being merged. Example: we can have a pool of 5 users from which at least 2 must approve a PR
