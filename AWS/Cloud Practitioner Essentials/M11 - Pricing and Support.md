...
Next in your AWS Cloud Practitioner learning journey, you will consider the basic principles, strategies, and services for migrating resources to the cloud.
...
|[AWS re:Post(opens in a new tab)](https://repost.aws/)|AWS re:Post is a community-driven, question-and-answer platform where users can seek help, share knowledge, and find solutions related to AWS services and technologies.|
